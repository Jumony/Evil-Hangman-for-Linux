...
// Precondition: current_word_family, new_key, and word are valid handles
//  to a MY_STRING object. guess is also a valid char
// Postcondition: new_key holds the data for the word family which is
//  essentially a possible option for the computer to choose to fool
//  the player with.
